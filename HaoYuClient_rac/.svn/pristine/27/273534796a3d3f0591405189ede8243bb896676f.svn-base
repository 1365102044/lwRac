...
typedef NS_ENUM(NSInteger, HomePageHotModelType) {
    HomePageHotModelTypeHotShare,
    HomePageHotModelTypeHotEvents,
};
@interface HYHomePageHotModel : HYBaseHomeModel
@property (nonatomic, copy) NSString * linkAddress;
@property (nonatomic, copy) NSString * pics;
@property (nonatomic, assign) HomePageHotModelType modelType;
@end
