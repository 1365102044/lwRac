...
/**
 跳转消息列表
 */
+ (void)pushMessageViewControllerWithSourceVC:(UIViewController *)sourceViewController
{
...
//    return messageVC;
    ...
    HYMessageDeatilViewController *deatilvc = [HYMessageDeatilViewController creatMessageDeatilWithTitleStr:@"消息" msgType:1 extend:nil];
    deatilvc.hidesBottomBarWhenPushed = YES;
    [sourceViewController.navigationController pushViewController:deatilvc animated:YES];
}
