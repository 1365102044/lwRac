...
@interface HYBaseTableViewController ()<DZNEmptyDataSetSource, DZNEmptyDataSetDelegate>
...
- (HYBaseTableView *)MainTableView {
    if (!_MainTableView) {
        _MainTableView = [[HYBaseTableView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
