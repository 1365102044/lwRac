...
- (void)postRequestAnWithurl:(NSString *)url
                ...
                successBlock:(HYNetRequestSuccessBlock)successBlock;
{
    [self postRequestAnWithurl:url paramters:paramters successBlock:successBlock failureBlock:nil];
}
...
- (void)postRequestWithurl:(NSString *)url
              ...
              successBlock:(HYNetRequestSuccessBlock)successBlock;
{
    [self postRequestWithurl:url paramters:paramters successBlock:successBlock failureBlock:nil];
}
