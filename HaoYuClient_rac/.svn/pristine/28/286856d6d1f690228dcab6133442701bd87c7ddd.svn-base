 ...
 */
+ (instancetype)showChoosePayMethodViewWithTitle:(NSString *)title desc:(NSString *)desc callBlackBlock:(HYEventCallBackBlock)callBlackBlock
{
    LWChoosePayMentView *instance = [LWChoosePayMentView new];
    [instance showChoosePayTypeViewWithTitle:title desc:desc callBlackBlock:callBlackBlock];
    return instance;
}
