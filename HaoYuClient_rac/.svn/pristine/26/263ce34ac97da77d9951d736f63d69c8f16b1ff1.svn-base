...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_bgView setBoundWidth:1 cornerRadius:6 boardColor:HYCOLOR.color_c4];
    }
    return self;
}
...
- (void)setUI
{
    ...
    for (int i = 0; i < _dataArray.count; i++) {
        ...
        itemview.titleLable.text = dict[@""];
        itemview.titleImageView.image = IMAGENAME(dict[@""]);
        ...
        [itemview mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            if (i == 0) {
                ...
                HYZhouBianItemView *lastView = tem.lastObject;
