...
{
    if ([projectModel isKindOfClass:[HYHouseRescourcesModel class]]) {
        HYHouseRescourcesModel *project_M = projectModel;
        _selectPro_Model = [[HYProjectLevelListModel alloc] init];
        _selectPro_Model.customId = project_M.customId;
        _selectPro_Model.houseItemName = project_M.hiItemName;
        _chooseMenDianView.rightLable.text = _selectPro_Model.houseItemName;
        _chooseMenDianView.userInteractionEnabled = NO;
    }else if ([projectModel isKindOfClass:[HYHuXingInforModel class]]){
        HYHuXingInforModel *huxing_M = projectModel;
        _selectPro_Model = [[HYProjectLevelListModel alloc] init];
        _selectPro_Model.customId = huxing_M.itemId;
        _selectPro_Model.houseItemName = huxing_M.itemName;
        _chooseMenDianView.rightLable.text = _selectPro_Model.houseItemName;
        _chooseMenDianView.userInteractionEnabled = NO;
        ...
        _huxingView.userInteractionEnabled = NO;
...
- (BOOL)checkPara
{
    ...
    if([_chooseMenDianView.rightLable.text isEqualToString:@"选择门店"]){
        ALERT(@"请选择门店");
        return NO;
    }
