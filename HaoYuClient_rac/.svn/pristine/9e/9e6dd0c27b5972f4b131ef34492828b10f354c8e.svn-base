...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HYCityModel *cityModels = self.cityDatas[indexPath.section];
    HYCityGroupModel *groupMode =  cityModels.cityGroup[indexPath.row];
    [HYPublic_LocalData share].location_City_M = groupMode;
    [HYPublic_LocalData share].location_City = groupMode.name;
    [HYPublic_LocalData share].location_City_Id = groupMode.cityID;
