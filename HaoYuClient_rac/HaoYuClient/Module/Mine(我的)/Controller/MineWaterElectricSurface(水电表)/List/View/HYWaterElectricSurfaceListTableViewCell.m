...
{
    [self.cellView.houseImage sd_setImageWithURL:[NSURL URLWithString:HYIMAGEURLSTRING(HYProjectImageURLStringList, contractModel.roomTypePic[@"small"])] placeholderImage:IMAGENAME(@"占位图-200_200")];
