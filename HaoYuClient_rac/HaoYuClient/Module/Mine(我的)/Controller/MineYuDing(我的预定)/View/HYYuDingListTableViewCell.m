...
- (void)setDataModel:(HYYuDingModel *)dataModel
{
    ...
    NSString *houseImage_url = dataModel.picObj[@"small"];
    [_cellView.houseImage sd_setImageWithURL:[NSURL URLWithString:houseImage_url] placeholderImage:IMAGENAME(@"占位图-240_160")];
    ...
    NSString *ting = dataModel.houseJson[@"fangNo"];
    _cellView.houseWhereLable.text = [NSString stringWithFormat:@"%@栋%@室",shi,ting];
    NSString *zujin = dataModel.houseJson[@"iosDedicated"];
