...
- (void)setDataModel:(HYCollectModel *)dataModel
{
    ...
    [_cellView.houseImage sd_setImageWithURL:[NSURL URLWithString:HYIMAGEURLSTRING(HYProjectImageURLStringMid, dataModel.roomTypePic[@"small"])] placeholderImage:IMAGENAME(@"占位图-200_200")];
    _cellView.houseWhereLable.text = dataModel.roomTypeName;
