...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HYHuXingInforModel *huxingModel = self.dataArray[indexPath.row];
    HYpicObjModel *picModel =  huxingModel.picObjModel;
    [cell.houseItemImageView sd_setImageWithURL:[NSURL URLWithString:HYIMAGEURLSTRING(HYProjectImageURLStringList, picModel.big)] placeholderImage:IMAGENAME(@"占位图-480_240")];
    cell.houseItemName.text = huxingModel.roomTypeName;
    return cell;
}
...
- (HYBaseCollectionView*)HuXingCollectView
{
    if (!_HuXingCollectView) {
        ...
        layout.itemSize = CGSizeMake(ADJUST_PERCENT_FLOAT(240), ADJUST_PERCENT_FLOAT(160));
